...
function draw() {
  ...
  // polycurve(xc,yc, poly, 0);
  // fill(93,115,250, 20);
  // polycurve(xc - random(-excitement, excitement), yc - random(-excitement, excitement), poly, 1);
  // polycurve(xc - random(-excitement, excitement), yc - random(-excitement, excitement), poly, 2);
  // fill(93,115,250,50);
  // polycurve(xc - random(-excitement, excitement), yc - random(-excitement, excitement), poly, 1);
  // polycurve(xc - random(-excitement, excitement), yc - random(-excitement, excitement), poly, 2);
  // fill(93,115,250,100);
