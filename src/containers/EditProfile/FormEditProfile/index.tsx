...
import ExportPrivateKeyModal from '@containers/Profile/Collected/Modal/ExportPrivateKey';
...
const FormEditProfile = ({ tab = 'account' }: { tab: string }) => {
  ...
  const [showModalPrivateKey, setShowModalPrivateKey] =
  ...
  const handleExport = async () => {
    try {
      ...
      if (privateKey && address && publicKey) {
        ...
        const _publicKey = SDK.convertPrivateKey(publicKey);
