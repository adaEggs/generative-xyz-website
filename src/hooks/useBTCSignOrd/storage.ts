...
// ORD
// ----------------
const getKeyBTCOrdAddress = (web3Address: string) =>
  `${web3Address}-${LocalStorageKey.ORD_ADDRESS}`;
...
// SIGN
// ----------------
const getKeyNonceSignWithAddress = (web3Address: string) =>
  `${web3Address}-${LocalStorageKey.FLAG_SIGN}`;
...
export {
  getBTCOrdAddress,
  setBTCOrdAddress,
  getNonceSignWithAddress,
  setNonceSignWithAddress,
};
